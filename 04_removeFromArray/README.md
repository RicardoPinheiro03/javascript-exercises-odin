...
- you can manipulate the original array you pass into the function call or create a new array that is returned as the result. - check
- how to remove a single element from an array - toSpliced
- how to deal with multiple optional arguments in a javascript function - check
